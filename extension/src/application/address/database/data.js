(() => {
  // =========================================================================
  // ADMINISTRATIVE BOUNDARIES DATABASE (VIETNAM) - GENERATED COMPRESSED
  // Source: https://github.com/madnh/hanhchinhvn
  // =========================================================================

  const CUSTOM_PROVINCES = [
    { name: "Thành phố Hồ Chí Minh", aliases: ["hcm", "tphcm", "sài gòn", "saigon", "ho chi minh", "tp hcm", "tp.hcm", "tp. hồ chí minh"] },
    { name: "Thành phố Hà Nội", aliases: ["hn", "hà nội", "ha noi", "tp hà nội", "tp.hà nội"] },
    { name: "Thành phố Đà Nẵng", aliases: ["đn", "đà nẵng", "da nang", "tp đà nẵng", "tp.đà nẵng"] },
    { name: "Thành phố Hải Phòng", aliases: ["hp", "hải phòng", "hai phong", "tp hải phòng", "tp.hải phòng"] },
    { name: "Thành phố Cần Thơ", aliases: ["ct", "cần thơ", "can tho", "tp cần thơ", "tp.cần thơ"] }
  ];

  const CUSTOM_PROVINCE_ALIASES = {
  "Tỉnh Lâm Đồng": [
    "đà lạt",
    "da lat",
    "lđ",
  ...
  "Thành phố Hải Phòng|Huyện Thuỷ Nguyên": [
    "Núi Đèo",
    "Minh Đức",
    "Lại Xuân",
    "An Sơn",
  ...
  "Thành phố Hải Phòng|Huyện An Dương": [
    "An Dương",
    "Lê Thiện",
    "Đại Bản",
    "An Hoà",
  ...
  "Tỉnh Thừa Thiên Huế|Huyện Phong Điền": [
    "Phong Điền",
    "Điền Hương",
    "Điền Môn",
    "Điền Lộc",
  ...
  "Tỉnh Thừa Thiên Huế|Huyện Quảng Điền": [
    "Sịa",
    "Quảng Thái",
    "Quảng Ngạn",
    "Quảng Lợi",
  ...
  "Tỉnh Thừa Thiên Huế|Huyện Phú Vang": [
    "Phú Thuận",
    "Phú An",
    "Phú Hải",
    "Phú Xuân",
  ...
  "Tỉnh Thừa Thiên Huế|Thị xã Hương Thủy": [
    "Phú Bài",
    "Thủy Thanh",
    "Thủy Dương",
    "Thủy Phương",
  ...
  "Tỉnh Thừa Thiên Huế|Thị xã Hương Trà": [
    "Tứ Hạ",
    "Hương Toàn",
    "Hương Vân",
    "Hương Văn",
  ...
  "Tỉnh Thừa Thiên Huế|Huyện Phú Lộc": [
    "Phú Lộc",
    "Lăng Cô",
    "Vinh Mỹ",
    "Vinh Hưng",
  ...
  "Tỉnh Thừa Thiên Huế|Huyện Nam Đông": [
    "Khe Tre",
    "Hương Phú",
    "Hương Sơn",
    "Hương Lộc",
  ...
  "Tỉnh Bình Dương|Thị xã Bến Cát": [
    "Mỹ Phước",
    "Chánh Phú Hòa",
    "An Điền",
    "An Tây",
  ...
  "Tỉnh Bà Rịa - Vũng Tàu|Huyện Long Điền": [
    "Long Điền",
    "Long Hải",
    "An Ngãi",
    "Tam Phước",
  ...
  "Tỉnh Bà Rịa - Vũng Tàu|Huyện Đất Đỏ": [
    "Đất Đỏ",
    "Phước Long Thọ",
    "Phước Hội",
    "Long Mỹ",
  ...
  "Tỉnh Tiền Giang|Thị xã Gò Công": [
    "Phường 3",
    "Phường 2",
    "Phường 4",
    "Phường 1",
  ...
  function generateProvinceAliases(name) {
    const aliases = new Set();
    const cleanName = name.trim();
    aliases.add(cleanName.toLowerCase());
    aliases.add(removeAccents(cleanName).toLowerCase());
    
    // Add custom province aliases
    if (CUSTOM_PROVINCE_ALIASES[cleanName]) {
      for (const a of CUSTOM_PROVINCE_ALIASES[cleanName]) {
        aliases.add(a.toLowerCase());
        aliases.add(removeAccents(a).toLowerCase());
      }
    }
    ...
    for (const p of prefixes) {
      if (cleanName.startsWith(p)) {
        const coreName = cleanName.slice(p.length).trim();
        const coreLower = coreName.toLowerCase();
        aliases.add(coreLower);
        aliases.add(removeAccents(coreLower));
      }
    }
    return Array.from(aliases);
  }

  function generateDistrictAliases(name) {
    const aliases = new Set();
    const cleanName = name.trim();
    aliases.add(cleanName.toLowerCase());
    aliases.add(removeAccents(cleanName).toLowerCase());
    ...
    const prefixes = [
      { prefix: "Quận ", short: ["q", "q."] },
      { prefix: "Huyện ", short: ["h", "h."] },
      { prefix: "Thành phố ", short: ["tp", "tp.", "thành phố"] },
      { prefix: "Thị xã ", short: ["tx", "tx.", "thị xã"] }
    ];
    
    for (const item of prefixes) {
      if (cleanName.startsWith(item.prefix)) {
        const coreName = cleanName.slice(item.prefix.length).trim();
        const coreLower = coreName.toLowerCase();
        const coreNoAccent = removeAccents(coreLower);
        
        aliases.add(coreLower);
        aliases.add(coreNoAccent);
        
        for (const s of item.short) {
          aliases.add(s + coreLower);
          aliases.add(s + " " + coreLower);
          aliases.add(s + coreNoAccent);
          aliases.add(s + " " + coreNoAccent);
        }
      }
    }
  ...
  // Compile ADM_DB
  const provinces = [];
  for (const name of RAW_PROVINCES) {
    const custom = CUSTOM_PROVINCES.find(p => p.name === name);
    const generated = generateProvinceAliases(name);
    const customAliases = CUSTOM_PROVINCE_ALIASES[name] || [];
    if (custom) {
      const combined = Array.from(new Set([...custom.aliases, ...customAliases, ...generated]));
      provinces.push({ name, aliases: combined });
    } else {
      const combined = Array.from(new Set([...customAliases, ...generated]));
      provinces.push({ name, aliases: combined });
    }
  }

  const districts = {};
  for (const [prov, distList] of Object.entries(RAW_DISTRICTS)) {
    districts[prov] = distList.map(name => ({
      name,
      aliases: generateDistrictAliases(name)
    }));
  }
