// frontend/assets/theme-manager.js
...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Không chèn nếu là trong panel của iframe extension (để panel tự quản lý hoặc gộp chung)
    if (document.getElementById('vnpost-autofill-panel')) {
      // Panel script sẽ tạo toggle riêng hoặc dùng theme-manager, tránh floating đè lên panel web
    } else {
